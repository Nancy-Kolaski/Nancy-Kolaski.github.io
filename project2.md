...
## Hypothesis: 
If a person is 65+ years of age, then they are more likely to die from influenza.


## Data Link 
This analysis utilized public databases from CDC & US Census Bureau consisting of influenza deaths by geography, population data, counts of influenza laboratory test results by state (in survery form), and surveys of flu shot rates in children.  The links are provided below.
...
**My Hypothesis was true**: If a person is 65+ years of age, then they are more likely to die from influenza.
...
The second scatterplot looks only within the vulnerable (65+ years) populations.  There is a correlation to these higher census states contributng to all flu related deaths.  When referring to the scatterplots, the top 5 states (noted on the left) were annotated by the orange dots within the right scatterplot to see this correlation clearly.

<img src="assets/scatterplots.png" alt="scatterplots" style="width: 600px; height: auto;">

 - *A higher census brings a larger vulnerable population & therefore, more deaths.*


* This choropleth map below shows many layers:
...
### **Insights:**
- Vulnerable populations (65+) make up most influenza related deaths.
