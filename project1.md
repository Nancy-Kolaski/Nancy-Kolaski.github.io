...
This analysis for Instacart was performed in order for stakeholders to better understand customer behavior and sales patterns to adapt marketing strategies for further sales growth by answering the key questions below.  This was an CareerFoundry assignment with the project breif outline included <a href="https://github.com/Nancy-Kolaski/Nancy-Kolaski.github.io/blob/main/assets/Project%20Briefs/A4_Data_Immersion_Project_Brief.pdf" target="_blank">here</a>.
