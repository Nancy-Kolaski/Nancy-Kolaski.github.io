  <a href="/">Home</a>   |  [Next Project](project2.md#project2)
...
- How can product price tags be simplified into price range groupings to help Marketing and Sales efforts?
- Are there certain types of products that are more popular than others? Which departments have had the highest frequency of product orders?
...
* People tend to spend the most money between **2-3am**.
...
* Most products cost between **$1-$15**, while a few are priced higher in **$15-$25** range.  This information will help to figure out appropriate and simpler price range groupings, as majority of items are lower priced.  Aim for $5 increments for simpler price groupings.

* The **top 10 products** ordered: **regular bananas** had the most orders, followed by organic bananas, organic strawberries, organic baby spinach, organic avocados, lemon, regular strawberries, limes, and organic white milk.  Note the popularity of **organic products**.

<img src="assets/Products_top.png" alt="Products_top" style="width: 600px; height: auto;">


* **Produce, dairy/eggs, snacks, beverages, frozen,** and **pantry** departments are the most popular departments.
    * Least popular departments are *international, alcohol,* and *pets*.
...
* The next bar chart shows that **Southern Regions** generate most of Instacart's spendings.  This is followed by Western Regions, then Midwest Regions, with Northeast spending the least.  This pattern is the same for both groups of people (high and low spenders).

<img src="assets/pie_bar.png" alt="pie_bar" style="width: 600px; height: auto;"> 

* The horizontal bar charts below are broken up by regions, showing the **top 5 departments for that region**.  All of them show a similar distribution of department preference in the following order: **1) Frozen, 2) Beverages, 3) Snacks, 4) Dairy Eggs, 5) Produce**
...
* Use promotional Ads for popular items to increase amount purchased, as well as Ads for lesser populated areas (international, pet, & alcohol).
